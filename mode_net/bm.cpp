...
void blockmodel:: bm_show_na_cab()
{
	...
	// // AND HERE, I WANT TO PRINT THE GROUPS
	// //compute_argmax_conf();
	// cout<<"#Group assignments:"<<endl;
	// //for(int q=0; q<Q; q++){
	// //	cout<<"Group #"<<q<<endl;
	// 	for(int n=0; n<N; n++){
	// 		//cout<<groups_true[q][n]<<" ";
	// 		//cout<<conf_infer[n]<<" ";
	// 		cout<<endl;
	// 	}
	// //}
	// // Everything between the nutty comments is mine.
}
//}}}
...
{
	ostringstream cmd;
		if(mode != 4) cmd<<"python spc.py "<<N<<" "<<fname<<" "<<Q<<" "<<mode;
